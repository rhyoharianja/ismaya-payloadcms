...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  CREATE TYPE "public"."enum_pages_blocks_carousel_collection" AS ENUM('pages', 'news', 'events', 'brands');
  CREATE TYPE "public"."enum_pages_blocks_slider_collection" AS ENUM('pages', 'news', 'events', 'brands');
  ...
  CREATE TYPE "public"."enum__pages_v_blocks_carousel_collection" AS ENUM('pages', 'news', 'events', 'brands');
  CREATE TYPE "public"."enum__pages_v_blocks_slider_collection" AS ENUM('pages', 'news', 'events', 'brands');
  ...
  CREATE TYPE "public"."enum_categories_group" AS ENUM('brands', 'events');
  ...
  CREATE TYPE "public"."enum_news_blocks_slider_collection" AS ENUM('pages', 'news', 'events', 'brands');
  ...
  CREATE TYPE "public"."enum_events_blocks_slider_collection" AS ENUM('pages', 'news', 'events', 'brands');
  ...
  CREATE TYPE "public"."enum_brands_blocks_slider_collection" AS ENUM('pages', 'news', 'events', 'brands');
  ...
  CREATE TABLE "brands_locations_open_hours" (
  	"_order" integer NOT NULL,
  	"_parent_id" varchar NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  	"title" varchar NOT NULL,
  ...
  CREATE TABLE "brands_locations_contact" (
  	"_order" integer NOT NULL,
  	"_parent_id" varchar NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  ...
  ALTER TABLE "pages_blocks_cta" ADD CONSTRAINT "pages_blocks_cta_icon_id_media_id_fk" FOREIGN KEY ("icon_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  ...
  ALTER TABLE "_pages_v_blocks_cta" ADD CONSTRAINT "_pages_v_blocks_cta_icon_id_media_id_fk" FOREIGN KEY ("icon_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  ...
  ALTER TABLE "brands_locations_open_hours" ADD CONSTRAINT "brands_locations_open_hours_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."brands_locations"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "brands_locations_contact" ADD CONSTRAINT "brands_locations_contact_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."brands_locations"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "brands_locations" ADD CONSTRAINT "brands_locations_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."brands"("id") ON DELETE cascade ON UPDATE no action;
  ...
  ALTER TABLE "brands" ADD CONSTRAINT "brands_category_id_categories_id_fk" FOREIGN KEY ("category_id") REFERENCES "public"."categories"("id") ON DELETE set null ON UPDATE no action;
  ...
  CREATE INDEX "pages_blocks_cta_icon_idx" ON "pages_blocks_cta" USING btree ("icon_id");
  ...
  CREATE INDEX "_pages_v_blocks_cta_icon_idx" ON "_pages_v_blocks_cta" USING btree ("icon_id");
  ...
  CREATE INDEX "brands_locations_open_hours_order_idx" ON "brands_locations_open_hours" USING btree ("_order");
  CREATE INDEX "brands_locations_open_hours_parent_id_idx" ON "brands_locations_open_hours" USING btree ("_parent_id");
  CREATE INDEX "brands_locations_contact_order_idx" ON "brands_locations_contact" USING btree ("_order");
  CREATE INDEX "brands_locations_contact_parent_id_idx" ON "brands_locations_contact" USING btree ("_parent_id");
  CREATE INDEX "brands_locations_order_idx" ON "brands_locations" USING btree ("_order");
  CREATE INDEX "brands_locations_parent_id_idx" ON "brands_locations" USING btree ("_parent_id");
  CREATE INDEX "brands_menu_idx" ON "brands" USING btree ("menu_id");
  CREATE INDEX "brands_category_idx" ON "brands" USING btree ("category_id");
...
export async function down({ db, payload, req }: MigrateDownArgs): Promise<void> {
  ...
  DROP TABLE "brands_locations_open_hours" CASCADE;
  DROP TABLE "brands_locations_contact" CASCADE;
  DROP TABLE "brands_locations" CASCADE;
